function calculate() {
    ...
    const priceCaixaCorreio = 50.00;
    const priceFechadura = 150.00;
    const priceTinta = 80.00;
    const priceSacosPeso = 30.00; // Adicione o preço do saco de peso
    const priceMotor = {
        motor4: 200.00,
        motor8: 250.00,
        motor16: 300.00,
    ...
    const motorNames = {
        ...
        x2motor4: '2x Motor 4 segundos',
        x2motor8: '2x Motor 8 segundos',
        x2motor16: '2x Motor 16 segundos'
    };
    ...
    const totalSacosPesos = sacosPeso > 0 ? sacosPeso : 0;
    ...
    // Despesas fixas como 3 dias do ajudante, agua e luz, materiais(arame de solda,flaps,gás)
    const despesasFixas = 800

    const totalVenda = (totalCost * 1.90) + despesasFixas;
    ...
    resultElement.innerHTML = `
        ...
        ${totalSacosPesos > 0 ?  `<p>Custo dos sacos de peso: ${sacosPeso} (R$ ${totalCostSacosPeso.toFixed(2)})</p>`: ''}
